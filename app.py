...
# -----------------------------------------------------------------------------
# Executive Summary (trimmed here for brevity — keep your existing function)
# -----------------------------------------------------------------------------
# ... keep your existing show_executive_summary, show_lead_status, and show_calls ...
